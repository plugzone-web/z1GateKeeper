...
const { filterAnsiControlSequences } = require('./ansi-filter');
...
class StateManager extends EventEmitter {
    ...
    appendTerminalOutput(sessionId, data) {
        ...
        if (connection) {
            ...
            // Filtrar sequências ANSI de controle que não devem aparecer (OSC, etc)
            text = filterAnsiControlSequences(text);
